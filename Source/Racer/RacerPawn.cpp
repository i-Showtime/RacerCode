...
void ARacerPawn::SetupPlayerInputComponent(class UInputComponent* InputComponent)
{
	// set up gameplay key bindings
	check(InputComponent);

	InputComponent->BindAxis("MoveForward", this, &ARacerPawn::MoveForward);
	InputComponent->BindAxis("MoveRight", this, &ARacerPawn::MoveRight);
	InputComponent->BindAxis("LookUp");
	InputComponent->BindAxis("LookRight");

	InputComponent->BindAction("Handbrake", IE_Pressed, this, &ARacerPawn::OnHandbrakePressed);
	InputComponent->BindAction("Handbrake", IE_Released, this, &ARacerPawn::OnHandbrakeReleased);
	InputComponent->BindAction("SwitchCamera", IE_Pressed, this, &ARacerPawn::OnToggleCamera);

	InputComponent->BindAction("ResetVR", IE_Pressed, this, &ARacerPawn::OnResetVR); 
}
...
void ARacerPawn::EnableIncarView(const bool bState, const bool bForce)
{
